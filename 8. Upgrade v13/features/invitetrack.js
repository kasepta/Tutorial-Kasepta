...
module.exports = async (client) => {
    ...
    client.on('messageCreate', async message => {
        ...
        return message.channel.send({content:`**${cachedInvites.size}** invites has loaded !`})
    })
    ...
    client.on('guildMemberAdd', async member => {
        ...
        try {
            ...
            member.guild.channels.cache.get('889520653290586173').send({embeds:[embed]})
        }
    })
}